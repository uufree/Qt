...
const QMetaObject TextTicker::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_TextTicker.data,
      qt_meta_data_TextTicker,  qt_static_metacall, nullptr, nullptr}
};
...
void *TextTicker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TextTicker.stringdata0))
        return static_cast<void*>(const_cast< TextTicker*>(this));
