...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayout_38->addLayout(horizontalLayout_9);
        ...
        horizontalLayout_38->addLayout(horizontalLayout_30);
        ...
        horizontalLayout_40->addLayout(horizontalLayout_33);
        ...
        horizontalLayout_40->addLayout(horizontalLayout_34);
        ...
        horizontalLayout_41->addLayout(verticalLayout_5);
        ...
        horizontalLayout_41->addWidget(lineChartWidget);

        horizontalLayout_41->setStretch(0, 90);
        horizontalLayout_41->setStretch(1, 90);

        gridLayout->addLayout(horizontalLayout_41, 0, 0, 1, 1);
        ...
        horizontalLayout_29->addLayout(verticalLayout_4);
        ...
        gridLayout->addLayout(horizontalLayout_29, 1, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_12->setText(QApplication::translate("MainWindow", "\316\270:", Q_NULLPTR));
